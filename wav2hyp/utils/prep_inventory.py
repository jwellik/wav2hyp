...
def prepare_awu_inventory():
    ...
    from vdapseisutils.utils.obspyutils import VInventory

    print("Reading inventory from csv...")
    inv = VInventory.read_csv("/home/jwellik/PYTHON/PKG/wav2hyp/examples_local/awu_stations.txt")
    print(inv.to_df())
    print("Writing inventory to StationXML...")
    inv.write("/home/jwellik/PYTHON/PKG/wav2hyp/examples_local/awu_inventory.xml", format="STATIONXML")
    print("Done.")
